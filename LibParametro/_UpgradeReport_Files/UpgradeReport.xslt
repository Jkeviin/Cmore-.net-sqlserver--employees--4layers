...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">Proyecto</th>
        <th _locID="PathTableHeader">Ruta de acceso</th>
        <th _locID="ErrorsTableHeader">Errores</th>
        <th _locID="WarningsTableHeader">Advertencias</th>
        <th _locID="MessagesTableHeader">Mensajes</th>
      </tr>
              ...
              <a>
                ...
                <xsl:choose>
                  <xsl:when test="@ProjectDisplayName = ''">
                    <span _locID="OverviewSolutionSpan">Solución</span>
                  </xsl:when>
                  <xsl:otherwise>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          Mostrar <xsl:value-of select="@MessageCount"/> mensajes adicionales
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          Ocultar <xsl:value-of select="@MessageCount"/> mensajes adicionales
        </a>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Projects" mode="ProjectDetails">
    ...
    <xsl:for-each select="Project">
      ...
      <xsl:choose>
        <xsl:when test="@ProjectDisplayName = ''">
          <h3 _locID="ProjectDisplayNameHeader">Solución</h3>
        </xsl:when>
        <xsl:otherwise>
          <h3>
            <xsl:value-of select="@ProjectDisplayName"/>
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">Mensaje</th>
        </tr>
              ...
              <xsl:choose>
                <xsl:when test="@ProjectDisplayName = ''">
                  <td class="messageCell" _locID="NoMessagesRow2">
                    La solución no registró mensajes.
                  </td>
                </xsl:when>
                <xsl:otherwise>
                  <td class="messageCell" _locID="NoMessagesRow">
                    <xsl:value-of select="@ProjectDisplayName"/> no registró mensajes.
                  </td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          Informe de migración - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">Información general</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">Solución y proyectos</h2>
